package com.max.b2c.item.util;

import com.max.b2c.common.exception.CustomException;
import com.max.b2c.common.util.SerializableUtil;
...
//"设置Redis键值setObject方法异常:key=" + key + " value=" + value + " cause="
    /**
     * 获取redis键值-Json
     * @param key
     * @return java.lang.Object
